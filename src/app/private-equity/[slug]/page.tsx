...
export default async function PEDetailPage({
  params,
}: {
  params: { slug: string };
}) {
      ...
      <article>
        <header className="mb-8">
          <div className="flex items-center gap-3 mb-3 flex-wrap">
            ...
            {article.dimension && (
              <span className="text-xs px-2 py-0.5 rounded bg-light-border/50 dark:bg-dark-border/50 text-light-muted dark:text-dark-muted">
                {article.dimension}
              </span>
            )}
          </div>
